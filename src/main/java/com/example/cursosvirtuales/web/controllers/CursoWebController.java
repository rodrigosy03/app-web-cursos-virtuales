...
public class CursoWebController {
	...
	@PostMapping("/guardar")
	public String crearCurso(@ModelAttribute("curso") Curso curso, @RequestParam("fechaInicio") String fechaInicioStr,
            @RequestParam("fechaFinalizacion") String fechaFinalizacionStr) {
